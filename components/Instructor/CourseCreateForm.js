...
const INITIAL_VALUE = {
	...
	access_time: "",
	requirements: "",
	what_you_will_learn: "lot",
	who_is_this_course_for: "for childrens",
	catId: "",
};
	...
	return (
		<form onSubmit={handleSubmit}>
			<div className="row">
				...
				<div className="col-md-6  !min-h-24">
					<div className="form-group">
						<label className="form-label fw-semibold form-label fw-semibold">
							Overview
						</label>
						{/* <RichTextEditor
							controls={controls}
